...
class MNISTBackCompat(datasets.MNIST):
     """
     MNISTInstance+Sample Dataset
     """
...
class MNISTInstance(MNISTBackCompat):
...
def get_mnist_dataloaders(batch_size=128, num_workers=4, is_instance=False, part = 1):
    """
    mnist
    """
    ...
    if is_instance:
        ...
        val_set = MNISTInstance(root=data_folder,
                                     download=True,
                                     train=True,
    ...
    #
    #
    test_set = MNISTInstance(root=data_folder,
                                 download=True,
                                 train=False,
                                 transform=test_transform)
...
class MNISTInstanceSample(MNISTBackCompat):
    """
    MNISTInstance+Sample Dataset
    """
